...
var Game = {
    ...
    endGameMenu: function (text) {
        ...
        Pong.context.fillText('Restart',
            Pong.canvas.width / 2,
            Pong.canvas.height / 2 + 60
        );
        ...
        Pong.canvas.addEventListener('click', function(event) {
            ...
            if (mouseX >= Pong.canvas.width / 2 - 50 &&
                mouseX <= Pong.canvas.width / 2 + 50 &&
                mouseY >= Pong.canvas.height / 2 + 40 &&
                mouseY <= Pong.canvas.height / 2 + 80) {
                // Restart the game
